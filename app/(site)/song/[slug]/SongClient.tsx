    ...
    if (error || !song) {
        return (
            <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="mt-2 text-muted-foreground">{error || "Song not found"}</p>
                <Button variant="ghost" size="sm" asChild className="mt-4 rounded-[4px]">
                    <Link href="/song" className="flex items-center">
                        <ChevronLeft className="mr-1 h-4 w-4" /> Back to Songs
                    </Link>
                </Button>
                        ...
                        {contributors.map((contributor) => (
                            <div key={contributor.email} className="flex items-center gap-2">
                                <Avatar className="h-8 w-8">
                                    <AvatarImage src={contributor.imageUrl} alt={contributor.name} />
